...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "list",           SEC_DEVELOPER,  true,  NULL,                                           "", listCommandTable     },
        ...
        { "groupsummon",    SEC_GAMEMASTER,      false, OldHandler<&ChatHandler::HandleGroupSummonCommand>,         "", NULL },
        ...
        { "itemmove",       SEC_DEVELOPER,     false, OldHandler<&ChatHandler::HandleItemMoveCommand>,            "", NULL },
        ...
        { "respawn",        SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandleRespawnCommand>,             "", NULL },
        ...
        { "movegens",       SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandleMovegensCommand>,            "", NULL },
        { "cometome",       SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandleComeToMeCommand>,            "", NULL },
        { "damage",         SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandleDamageCommand>,              "", NULL },
        { "combatstop",     SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleCombatStopCommand>,          "", NULL },
        { "flusharenapoints", SEC_HGAMEMASTER, false, OldHandler<&ChatHandler::HandleFlushArenaPointsCommand>,    "", NULL },
        ...
        { "listfreeze",     SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandleListFreezeCommand>,          "", NULL },

        { "possess",        SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandlePossessCommand>,             "", NULL },
        { "unpossess",      SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandleUnPossessCommand>,           "", NULL },
        { "bindsight",      SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandleBindSightCommand>,           "", NULL },
        { "unbindsight",    SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandleUnbindSightCommand>,         "", NULL },
        { "playall",        SEC_DEVELOPER,  false, OldHandler<&ChatHandler::HandlePlayAllCommand>,             "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };
