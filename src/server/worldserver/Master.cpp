...
int Master::Run()
{
    ...
    LoginDatabase.DirectPExecute("UPDATE realmlist SET color = (flag & ~%u) | %u WHERE id = '%d'", REALM_FLAG_OFFLINE, REALM_FLAG_INVALID, realmID);
    ...
    LoginDatabase.DirectPExecute("UPDATE realmlist SET color = flag & ~%u, population = 0 WHERE id = '%u'", REALM_FLAG_INVALID, realmID);
    ...
    // set server offline
    LoginDatabase.DirectPExecute("UPDATE realmlist SET color = flag | %u WHERE id = '%d'", REALM_FLAG_OFFLINE, realmID);
